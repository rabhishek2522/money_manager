	...
	<body class="nav-md">
				...
				<div class="right_col" role="main">
					<div class="">
						<div class="row">
									...
									<div class="x_content">
										...
										<form id="demo-form2" class="form-horizontal form-label-left">
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">View Transactions for: </label>
											...
											<div id="buttonFormGroup" class="form-group displayNone">
												<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
													<button id="viewtxns" class="btn btn-success pull-right">View</button>
												</div>
											</div>
										</form>
									</div>
							...
							<!-- filter results -->
							<div id="txns" class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
		...
		<script>
			$(document).ready(function() {
				...
				// Intialize the Transactions Filter Table with jQuery Datatables
